...
Secktor.cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (text.split(" ")[0]) {
                ...
                let str = `*❋ ─═━•┇مـرحـبـا يـا ${citel.pushName}┇•━═─ ❋*\n`
                str += `*❋ ─═══━•┇❄️┇•━═══─ ❋*

*┇اهـلاً بـك فـي اوامـر الـبـوته الـكـيـوت مـلـكـة الـجـلـيـد "إلـسـا" ❄️┇*

*❆ اسـم الـبـوتـه 🪅 ⦂『إلـسـا』*

*❆ وقـت الـعـمـل 🕑 ⦂『${runtime(process.uptime())}』*

*❆ الـمـطـوريـن 🪄 ⦂ 『الـجـزار&ايـتـاشـي』*
...
*❆ أرقـام الـمـطـوريـن 👨‍💻 ⦂『+201098906252 & +96178965440』*
