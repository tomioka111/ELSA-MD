...
try {
    ...
    console.log("? Connected to the ELSA  DB")
} catch {
...
let cc = Config.sessionName.replace(/ELSA;;;/g, "").replace(/BLACK;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
...
app.listen(port, () => console.log(`Elsa Server listening on port http://localhost:${port}!`));
